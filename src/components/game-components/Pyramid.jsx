...
const Pyramid = () => {
  return (
    <div className="flex flex-col justify-between h-screen px-1 bg-[#040450c9] ">
      ...
      <div className="flex flex-col w-full my-5 pt-3">
        <ul className="flex flex-col px-2">
          {prizeMoney.map((m) => (
            <li key={m.id} className="flex h-full py-2">
              <span className="block w-1/4 text-lg text-center">
                {m.id}
              </span>
